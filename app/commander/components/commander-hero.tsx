  ...
  return (
    <Panel className="fx-panel-scan overflow-hidden">
      <div className="flex flex-col gap-6 p-6 md:flex-row md:items-start">
        ...
        {/* ── Avatar placeholder ── */}
        <div className="fx-chamfer relative flex h-24 w-24 shrink-0 items-center justify-center border border-sky-900/40 bg-black/60 md:h-32 md:w-32">
          <i className="icarus-terminal-shield text-4xl text-sky-500/30 md:text-5xl"></i>
          <div className="absolute bottom-0 left-0 right-0 border-t border-sky-900/20 py-1 text-center text-[0.65rem] uppercase tracking-widest text-neutral-700">
            NO IMG
          </div>
        </div>
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mb-4 grid grid-cols-2 gap-x-6 gap-y-2 text-[0.65rem] uppercase tracking-widest sm:grid-cols-4">
            ...
            <div>
              ...
              <p className="text-sky-400/80">{commander.credits.toLocaleString()} CR</p>
            </div>
            <div>
              <p className="mb-0.5 text-neutral-700">Net Worth</p>
              <p className="text-sky-400/60">{commander.credits.toLocaleString()} CR</p>
            </div>
          </div>
