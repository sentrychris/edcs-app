...
export default function FieldGuideTopicPage({
  topic,
  moduleHref,
  moduleTitle,
  protocolLabel,
        ...
        <div className="flex h-full flex-col lg:col-span-2">
          <Panel variant="muted" className="fx-chamfer flex flex-1 flex-col">
            <div className="border-b border-sky-900/20 px-4 py-3">
              <SectionHeader icon={profileIcon} title={profileTitle} className="mb-0 border-0 pb-0" />
            </div>
              ...
              <div className="relative grid h-full grid-cols-1 gap-4 md:grid-cols-2">
                <div className="flex min-h-[220px] items-center justify-center">
                  <div className="relative h-56 w-56">
                    <div className="absolute inset-0 border border-sky-500/15" />
                    ...
                    <div className="absolute inset-x-5 top-1/2 h-px bg-sky-500/20" />
                    <div className="absolute inset-y-5 left-1/2 w-px bg-sky-500/20" />
