...
export const metadata: Metadata = {
  title: "Tidal Locking | Orbital Mechanics | Knowledge Base | ED:CS",
...
export default function TidalLockingPage() {
  return (
    <>
      ...
      {/* ── Breadcrumb ── */}
      <BreadcrumbNav
        backHref="/knowledge-base/orbital-mechanics"
          ...
          {examples.map((ex) => (
            <div key={ex.name} className="border border-sky-900/20 p-3">
              <div className="mb-2 flex items-start justify-between gap-3">
                ...
                <span className="shrink-0 text-[0.7rem] uppercase tracking-widest text-sky-400/60">{ex.locked}</span>
              </div>
