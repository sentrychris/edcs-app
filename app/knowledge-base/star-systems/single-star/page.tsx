...
export const metadata: Metadata = {
  title: "Single Star | Star Systems | Knowledge Base | ED:CS",
...
export default function SingleStarPage() {
  return (
    <>
      ...
      {/* ── Breadcrumb ── */}
      <BreadcrumbNav
        backHref="/knowledge-base/star-systems"
          ...
          <Panel variant="muted" className="fx-chamfer p-4 md:p-5">
            ...
            <div className="space-y-3 text-xs uppercase tracking-wide text-neutral-500">
              ...
              <p>
                ...
                <Link className="text-sky-400/80 hover:text-sky-300" href="/knowledge-base/orbital-mechanics/orbital-resonance">orbital resonance</Link> with each other.
              </p>
            </div>
          </Panel>
