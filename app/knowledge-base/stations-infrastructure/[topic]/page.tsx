...
export function generateMetadata({ params }: Props): Metadata {
  ...
  return {
    title: topic
      ? `${topic.title} | Stations, Settlements & Infrastructure | Knowledge Base | ED:CS`
      : "Stations, Settlements & Infrastructure | Knowledge Base | ED:CS",
...
export default function StationsInfrastructureTopicPage({ params }: Props) {
  return (
    <FieldGuideTopicPage
      ...
      moduleHref="/knowledge-base/stations-infrastructure"
