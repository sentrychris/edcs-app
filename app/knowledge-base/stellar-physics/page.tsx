...
import KnowledgeBaseModuleSidebar from "../components/knowledge-base-module-sidebar";

export const metadata: Metadata = {
  title: "Stellar Physics | Knowledge Base | ED:CS",
  description: "Simulations and reference guides exploring the physics of stars — classification, evolution, and remnants.",
};

const topics = [
  {
    href:        "/knowledge-base/stellar-physics/stellar-classification",
  ...
  {
    href:        "/knowledge-base/stellar-physics/stellar-remnants",
    icon:        "icarus-terminal-star",
  ...
  {
    href:        "/knowledge-base/stellar-physics/stellar-nucleosynthesis",
    icon:        "icarus-terminal-star",
  ...
  {
    href:        "/knowledge-base/stellar-physics/binary-stars",
    icon:        "icarus-terminal-star",
    title:       "Binary Stars",
  ...
  {
    href:        "/knowledge-base/stellar-physics/supernovae",
    icon:        "icarus-terminal-star",
    title:       "Supernovae",
  ...
  {
    href:        "/knowledge-base/stellar-physics/star-formation",
    icon:        "icarus-terminal-star",
    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
        ...
        <KnowledgeBaseModuleSidebar
          ...
          lensTitle="Stellar Lens"
          paragraphs={[
            "This module follows the life of stars from birth through fusion, classification, interaction, explosion, and final remnant.",
            "It is the physics layer beneath exploration: star class affects fuel scooping, habitable zones, system colour, hazards, and the rare objects commanders seek out.",
          ]}
