...
export function generateMetadata({ params }: Props): Metadata {
  ...
  return {
    title: `${topic.title} | Exobiology | Learning Resources | ED:CS`,
...
export default function ExobiologyTopicPage({ params }: Props) {
  ...
  return (
    <>
      ...
      <BreadcrumbNav
        backHref="/learning/exobiology"
        backLabel="Exobiology"
        ...
        <div className="flex h-full flex-col lg:col-span-2">
          <Panel variant="muted" className="fx-chamfer flex flex-1 flex-col">
            <div className="border-b border-sky-900/20 px-4 py-3">
              <SectionHeader icon="icarus-terminal-planet-atmosphere" title="Bio-Survey Profile" className="mb-0 border-0 pb-0" />
            </div>
              ...
              <div className="relative grid h-full grid-cols-1 gap-4 md:grid-cols-2">
                <div className="flex min-h-[220px] items-center justify-center">
                  <div className="relative h-56 w-56">
                    ...
                    <div className="absolute inset-x-6 bottom-12 h-px bg-sky-500/25" />
                    <div className="absolute bottom-12 left-1/2 h-28 w-px -translate-x-1/2 bg-sky-500/20" />
                    <div className="absolute bottom-[3rem] left-1/2 h-2 w-2 -translate-x-1/2 bg-sky-400/70 shadow-[0_0_18px_rgba(56,189,248,0.7)]" />
