...
export function generateMetadata({ params }: Props): Metadata {
  ...
  return {
    title: `${topic.title} | Exploration & Surveying | Learning Resources | ED:CS`,
...
export default function ExplorationSurveyingTopicPage({ params }: Props) {
  ...
  return (
    <>
      ...
      <BreadcrumbNav
        backHref="/learning/exploration-surveying"
        backLabel="Exploration & Surveying"
        ...
        <div className="flex h-full flex-col lg:col-span-2">
          <Panel variant="muted" className="fx-chamfer flex flex-1 flex-col">
            <div className="border-b border-sky-900/20 px-4 py-3">
              <SectionHeader icon="icarus-terminal-scan" title="Survey Profile" className="mb-0 border-0 pb-0" />
            </div>
              ...
              <div className="relative grid h-full grid-cols-1 gap-4 md:grid-cols-2">
                <div className="flex min-h-[220px] items-center justify-center">
                  <div className="relative h-56 w-56">
                    ...
                    <div className="absolute inset-7 rounded-full border border-sky-500/20" />
                    <div className="absolute inset-14 rounded-full border border-sky-500/30" />
                    <div className="absolute inset-x-3 top-1/2 h-px bg-sky-500/20" />
                    <div className="absolute inset-y-3 left-1/2 w-px bg-sky-500/20" />
