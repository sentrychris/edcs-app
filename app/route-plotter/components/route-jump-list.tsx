...
export default function RouteJumpList({ waypoints }: Props) {
  ...
  return (
    <Panel className="overflow-hidden">
      ...
      {/* ── Summary stats ── */}
      <div className="grid grid-cols-2 gap-px border-b border-sky-900/20 bg-sky-900/10">
      ...
      {/* ── Waypoint list ── */}
      <div className="divide-y divide-sky-900/10 overflow-y-auto" style={{ maxHeight: "420px" }}>
          ...
          return (
            <div
              ...
              className={`flex items-start gap-3 px-4 py-3 transition-colors ${
                isOrigin || isDestination ? "bg-sky-900/10" : "hover:bg-sky-900/5"
              }`}
            >
              ...
              <div className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center border border-sky-900/30 text-xs font-bold">
                {isOrigin ? (
                  ...
                  <i className="icarus-terminal-star text-xs text-sky-400"></i>
                ) : (
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-1 flex flex-wrap items-center gap-2 text-xs uppercase tracking-widest text-neutral-600">
                  {isOrigin ? (
                    ...
                    <>
                      <span className="text-sky-400/70">Destination</span>
