...
// Hue values are `hue-rotate` degrees applied to the base UI accent
// (rgb(80,180,245), HSL hue ≈ 204°). Each value is target_hue − 204 (mod 360),
// so the rendered colour lands on the preview's hue.
export const THEMES: Theme[] = [
  ...
  { id: "cartograph", label: "Cartograph", description: "Teal — explorer palette",         preview: "rgb(22,195,190)",   hue: 334, saturate: 1.15, brightness: 1.0,  contrast: 1.0  },
  { id: "viper",      label: "Viper",      description: "Green — combat visor",            preview: "rgb(40,220,70)",    hue: 286, saturate: 1.3,  brightness: 1.0,  contrast: 1.0  },
  { id: "void",       label: "Void",       description: "Purple — deep space",             preview: "rgb(148,22,245)",   hue: 70,  saturate: 0.85, brightness: 1.2,  contrast: 1.0 },
  { id: "combat",     label: "Combat",     description: "Red — threat alert",              preview: "rgb(249,22,55)",    hue: 147, saturate: 1.35, brightness: 1.0,  contrast: 1.0  },
  { id: "imperial",   label: "Imperial",   description: "Blue — Imperial Navy cold",       preview: "rgb(30,100,245)",   hue: 16,  saturate: 0.75, brightness: 0.95, contrast: 1.0  },
  { id: "thargoid",   label: "Thargoid",   description: "Bio — alien bioluminescent",      preview: "rgb(85,245,22)",    hue: 259, saturate: 1.55, brightness: 0.88, contrast: 1.0  },
  { id: "ghost",      label: "Ghost",      description: "Mono — surveillance minimal",     preview: "rgb(125,140,152)",  hue: 0,   saturate: 0.1,  brightness: 1.25, contrast: 1.0  },
];
